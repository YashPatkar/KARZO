...
from driver.views import driver_register, update_driver_profile, check_verifications
...
urlpatterns = [
    ...
    path('<str:email>/check-verifications/', check_verifications, name='check_verifications'),
]